...
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Search Key','Y',100,TO_TIMESTAMP('2013-01-23 17:44:23','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2013-01-23 17:44:23','YYYY-MM-DD HH24:MI:SS'),100,0,0,'N','N')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Element (ColumnName,AD_Element_ID,EntityType,Name,PrintName,AD_Element_UU,AD_Client_ID,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES ('X_DepositBatch_ID',202195,'D','Receipts into Batch','Receipts into Batch','bfada75f-e83d-4726-8cf3-edf1c771f2cf',0,TO_TIMESTAMP('2013-01-23 17:44:25','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-01-23 17:44:25','YYYY-MM-DD HH24:MI:SS'),0,100,100,'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
--INSERT INTO AD_Element (ColumnName,AD_Element_ID,EntityType,Name,PrintName,AD_Element_UU,AD_Client_ID,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES ('DateDeposit',202197,'D','Deposit Date','Deposit Date','d11ff847-d57c-4f51-92e9-c7bed69071cc',0,TO_TIMESTAMP('2013-01-23 17:48:00','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-01-23 17:48:00','YYYY-MM-DD HH24:MI:SS'),0,100,100,'Y')
;
...
If the document type of your document has no automatic document sequence defined, the field is empty if you create a new document. This is for documents which usually have an external number (like vendor invoice).  If you leave the field empty, the system will generate a document number for you. The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Document No','Y',100,TO_TIMESTAMP('2013-01-23 17:52:12','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2013-01-23 17:52:12','YYYY-MM-DD HH24:MI:SS'),100,0,0,'N','N')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Sequence (UpdatedBy,StartNewYear,CurrentNextSys,IsTableID,CurrentNext,IsAudited,IsAutoSequence,AD_Sequence_ID,AD_Sequence_UU,Description,Name,IncrementNo,AD_Org_ID,AD_Client_ID,Created,CreatedBy,Updated,IsActive,StartNo) VALUES (100,'N',200000,'Y',1000000,'N','Y',200052,'2d30472a-cb6b-4631-b037-a18997bc61b9','Table X_DepositBatchLine','X_DepositBatchLine',1,0,0,TO_TIMESTAMP('2013-01-23 17:55:56','YYYY-MM-DD HH24:MI:SS'),100,TO_TIMESTAMP('2013-01-23 17:55:56','YYYY-MM-DD HH24:MI:SS'),'Y',1000000)
;

-- Jan 23, 2013 5:56:25 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Table SET Name='Receipts into Batch Line',Updated=TO_TIMESTAMP('2013-01-23 17:56:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=200057
;
...
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','Search Key','Y',100,TO_TIMESTAMP('2013-01-23 17:56:43','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2013-01-23 17:56:43','YYYY-MM-DD HH24:MI:SS'),100,0,0,'N','N')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Element (ColumnName,AD_Element_ID,EntityType,Name,PrintName,AD_Element_UU,AD_Client_ID,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES ('X_DepositBatchLine_ID',202199,'D','Receipts into Batch Line','Receipts into Batch Line','0ecc1c05-ce0d-4668-b037-4cf0bc5e4a6d',0,TO_TIMESTAMP('2013-01-23 17:56:45','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-01-23 17:56:45','YYYY-MM-DD HH24:MI:SS'),0,100,100,'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Column SET IsUpdateable='N', Name='Deposit Batch',Updated=TO_TIMESTAMP('2013-01-23 18:01:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=208441
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Element SET PrintName='Deposit Batch',Updated=TO_TIMESTAMP('2013-01-23 18:01:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=202195
;
...
-- Jan 23, 2013 6:01:25 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_PrintFormatItem SET PrintName='Deposit Batch', Name='Receipts into Batch' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=202195)
;

-- Jan 23, 2013 6:01:45 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Element SET Name='Deposit Batch Line', PrintName='Deposit Batch Line',Updated=TO_TIMESTAMP('2013-01-23 18:01:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=202199
;
...
-- Jan 23, 2013 6:01:45 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_PrintFormatItem SET PrintName='Deposit Batch Line', Name='Deposit Batch Line' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=202199)
;

-- Jan 23, 2013 6:01:57 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Element SET Name='Deposit Batch',Updated=TO_TIMESTAMP('2013-01-23 18:01:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=202195
;
...
-- Jan 23, 2013 6:01:57 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_PrintFormatItem SET PrintName='Deposit Batch', Name='Deposit Batch' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=202195)
;

-- Jan 23, 2013 6:02:07 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Table SET Name='Deposit Batch Line',Updated=TO_TIMESTAMP('2013-01-23 18:02:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=200057
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Table SET Name='Deposit Batch',Updated=TO_TIMESTAMP('2013-01-23 18:02:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=200056
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
CREATE TABLE X_DepositBatchLine (AD_Client_ID NUMERIC(10) NOT NULL, AD_Org_ID NUMERIC(10) NOT NULL, C_Payment_ID NUMERIC(10) NOT NULL, Created TIMESTAMP NOT NULL, CreatedBy NUMERIC(10) NOT NULL, IsActive CHAR(1) DEFAULT 'Y' CHECK (IsActive IN ('Y','N')) NOT NULL, Line NUMERIC(10) NOT NULL, PayAmt NUMERIC NOT NULL, Processed CHAR(1) CHECK (Processed IN ('Y','N')) NOT NULL, Processing CHAR(1) CHECK (Processing IN ('Y','N')) NOT NULL, Updated TIMESTAMP NOT NULL, UpdatedBy NUMERIC(10) NOT NULL, X_DepositBatch_ID NUMERIC(10) NOT NULL, X_DepositBatchLine_ID NUMERIC(10) NOT NULL, X_DepositBatchLine_UU VARCHAR(36) DEFAULT NULL , CONSTRAINT X_DepositBatchLine_Key PRIMARY KEY (X_DepositBatchLine_ID))
;

-- Jan 23, 2013 6:03:36 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Element (ColumnName,AD_Element_ID,EntityType,Name,PrintName,AD_Element_UU,AD_Client_ID,Created,Updated,AD_Org_ID,CreatedBy,UpdatedBy,IsActive) VALUES ('X_CreateFromBatch',202201,'D','Create From Batch','Create From Batch','a56bf24b-a9b0-459b-8db3-17fff6f8d9c1',0,TO_TIMESTAMP('2013-01-23 18:03:35','YYYY-MM-DD HH24:MI:SS'),TO_TIMESTAMP('2013-01-23 18:03:35','YYYY-MM-DD HH24:MI:SS'),0,100,100,'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',328,1,'N','N',208442,'Y',201691,'N','D','Create From Batch','N','Y','cdf9b481-ae14-4458-ac87-44afbb2fe155',100,0,TO_TIMESTAMP('2013-01-23 18:08:50','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:08:50','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET XPosition=2, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:11:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201691
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Tab (ImportFields,Processing,IsSingleRow,AD_Window_ID,SeqNo,IsTranslationTab,IsSortTab,AD_Table_ID,HasTree,IsReadOnly,IsInfoTab,AD_Tab_UU,IsInsertRecord,IsAdvancedTab,TabLevel,EntityType,Name,AD_Tab_ID,AD_Client_ID,Updated,AD_Org_ID,Created,CreatedBy,UpdatedBy,IsActive) VALUES ('N','N','N',200031,10,'N','N',200056,'N','N','N','b2b0e8f8-0bbb-47b5-8dce-1accf43ad27c','Y','N',0,'D','Batch',200067,0,TO_TIMESTAMP('2013-01-23 18:12:53','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-01-23 18:12:53','YYYY-MM-DD HH24:MI:SS'),100,100,'Y')
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','D','The record is active in the system','Active','N','Y','9124887c-0d0c-4985-ab70-e135578d4f13',100,0,TO_TIMESTAMP('2013-01-23 18:12:56','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:12:56','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,10,'N','N',208412,'Y',201693,'N','The Bank Account identifies an account at this Bank.','D','Account at the Bank','Bank Account','N','Y','b93077eb-579f-41d0-9e87-50a20d100a65',100,0,TO_TIMESTAMP('2013-01-23 18:12:57','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:12:57','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,1,'N','N',208414,'Y',201695,'N','The Create From process will create a new document based on information in an existing document selected by the user.','D','Process which will generate a new document lines based on an existing document','Create lines from','N','Y','809b4770-3ac7-44ca-883a-403e3fcc99df',100,0,TO_TIMESTAMP('2013-01-23 18:12:59','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:12:59','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,14,'N','N',208417,'Y',201696,'N','D','Deposit Amount','N','Y','3d6714d8-e720-4aca-bde7-87a680611ac1',100,0,TO_TIMESTAMP('2013-01-23 18:13:00','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:00','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid) VALUES ('N',200067,22,'N','N',208410,'Y',201697,'N','D','Deposit Batch','N','N','42e24a69-e7f9-4219-b121-5e5a53cf504e',100,0,TO_TIMESTAMP('2013-01-23 18:13:01','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:01','YYYY-MM-DD HH24:MI:SS'),'Y','N')
;
...
-- Jan 23, 2013 6:13:02 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,7,'N','N',208415,'Y',201698,'N','D','Deposit Date','N','Y','5afd8215-cc8e-4c10-9191-9ece1df7e760',100,0,TO_TIMESTAMP('2013-01-23 18:13:02','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:02','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,255,'N','N',208402,'Y',201699,'N','A description is limited to 255 characters.','D','Optional short description of the record','Description','N','Y','0836c263-cbd8-4051-98f4-3f389990d6d8',100,0,TO_TIMESTAMP('2013-01-23 18:13:02','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:02','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,7,'N','N',208416,'Y',201700,'N','The Document Date indicates the date the document was generated.  It may or may not be the same as the accounting date.','D','Date of the Document','Document Date','N','Y','ae0d05d5-8aa5-409b-a5e2-ddde334ecf06',100,0,TO_TIMESTAMP('2013-01-23 18:13:03','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:03','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
If the document type of your document has no automatic document sequence defined, the field is empty if you create a new document. This is for documents which usually have an external number (like vendor invoice).  If you leave the field empty, the system will generate a document number for you. The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','D','Document sequence number of the document','Document No','N','Y','a9e341f3-f2dd-4ab9-b9f2-d9eebb9745d0',100,0,TO_TIMESTAMP('2013-01-23 18:13:04','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:04','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,10,'N','N',208413,'Y',201703,'N','The Document Type determines document sequence and processing rules','D','Document type or rules','Document Type','N','Y','c14cdcd0-48a6-4f58-81e6-076117137cab',100,0,TO_TIMESTAMP('2013-01-23 18:13:06','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:06','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,22,'N','N',208399,'Y',201704,'N','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','D','Organizational entity within client','Organization','N','Y','41ed507f-b5e8-4b5f-a1a3-9492c34fbffc',100,0,TO_TIMESTAMP('2013-01-23 18:13:07','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:07','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,1,'N','N',208421,'Y',201705,'N','D','Process Now','N','Y','c2172400-027c-4496-a7fd-53a4e94691c3',100,0,TO_TIMESTAMP('2013-01-23 18:13:08','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:08','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,1,'N','N',208420,'Y',201706,'N','The Processed checkbox indicates that a document has been processed.','D','The document has been processed','Processed','N','Y','d6034f0a-77cd-4e51-9f8e-e25d9496094b',100,0,TO_TIMESTAMP('2013-01-23 18:13:09','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:09','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200067,36,'N','N',208411,'Y',201707,'N','D','X_DepositBatch_UU','N','Y','097b9034-c40f-484a-89ac-a0ccae0d2363',100,0,TO_TIMESTAMP('2013-01-23 18:13:10','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:13:10','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:15:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201704
;

-- Jan 23, 2013 6:16:04 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:16:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201694
;

-- Jan 23, 2013 6:16:09 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET XPosition=4,Updated=TO_TIMESTAMP('2013-01-23 18:16:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201704
;

-- Jan 23, 2013 6:16:23 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:16:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201693
;

-- Jan 23, 2013 6:16:40 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:16:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201698
;

-- Jan 23, 2013 6:16:42 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:16:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201703
;

-- Jan 23, 2013 6:17:00 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:17:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201701
;

-- Jan 23, 2013 6:17:06 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:17:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201700
;

-- Jan 23, 2013 6:17:12 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=5,Updated=TO_TIMESTAMP('2013-01-23 18:17:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201699
;

-- Jan 23, 2013 6:17:15 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:17:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201696
;

-- Jan 23, 2013 6:17:39 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', XPosition=5, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:17:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201695
;

-- Jan 23, 2013 6:18:08 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET XPosition=2, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:18:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201692
;

-- Jan 23, 2013 6:18:49 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', DisplayLogic='@DepositAmt@!0', XPosition=5, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:18:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201705
;

-- Jan 23, 2013 6:19:02 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsReadOnly='Y', XPosition=2, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:19:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201706
;

-- Jan 23, 2013 6:19:11 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsReadOnly='Y',Updated=TO_TIMESTAMP('2013-01-23 18:19:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201696
;

-- Jan 23, 2013 6:19:43 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Tab (ImportFields,Processing,IsSingleRow,AD_Window_ID,SeqNo,IsTranslationTab,IsSortTab,AD_Table_ID,HasTree,IsReadOnly,IsInfoTab,AD_Tab_UU,IsInsertRecord,IsAdvancedTab,TabLevel,EntityType,Name,AD_Tab_ID,ReadOnlyLogic,AD_Client_ID,Updated,AD_Org_ID,Created,CreatedBy,UpdatedBy,IsActive) VALUES ('N','N','N',200031,20,'N','N',200057,'N','N','N','3adbb99b-98d8-450f-83a0-87ebc00d2950','Y','N',1,'D','Lines',200068,'@Processed@=''Y''',0,TO_TIMESTAMP('2013-01-23 18:19:42','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-01-23 18:19:42','YYYY-MM-DD HH24:MI:SS'),100,100,'Y')
;
...
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','D','The record is active in the system','Active','N','Y','e9fa326b-c53b-4428-a7a3-fd98f9dd68c5',100,0,TO_TIMESTAMP('2013-01-23 18:19:44','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:44','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,10,'N','N',208441,'Y',201710,'N','D','Deposit Batch','N','Y','0c853d59-6d17-4653-b036-ec3a51478185',100,0,TO_TIMESTAMP('2013-01-23 18:19:46','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:46','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive,IsDisplayedGrid) VALUES ('N',200068,22,'N','N',208434,'Y',201711,'N','D','Deposit Batch Line','N','N','97d87d68-da47-4d84-9fb7-998fb0757a1b',100,0,TO_TIMESTAMP('2013-01-23 18:19:47','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:47','YYYY-MM-DD HH24:MI:SS'),'Y','N')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,14,'N','N',208438,'Y',201712,'N','Indicates the unique line for a document.  It will also control the display order of the lines within a document.','D','Unique line for this document','Line No','N','Y','8d47a707-97e7-49ef-8db3-3b19a6864f32',100,0,TO_TIMESTAMP('2013-01-23 18:19:51','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:51','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,22,'N','N',208423,'Y',201713,'N','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','D','Organizational entity within client','Organization','N','Y','f92541af-e885-426c-af88-c75cf30314fe',100,0,TO_TIMESTAMP('2013-01-23 18:19:52','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:52','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,10,'N','N',208437,'Y',201714,'N','The Payment is a unique identifier of this payment.','D','Payment identifier','Payment','N','Y','3951ce27-652a-4a11-b1e5-a4d47c56a860',100,0,TO_TIMESTAMP('2013-01-23 18:19:53','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:53','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,1,'N','N',208440,'Y',201716,'N','D','Process Now','N','Y','104eefdd-cc7b-46c6-bb19-18b04b13aff5',100,0,TO_TIMESTAMP('2013-01-23 18:19:55','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:55','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,Help,EntityType,Description,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,1,'N','N',208439,'Y',201717,'N','The Processed checkbox indicates that a document has been processed.','D','The document has been processed','Processed','N','Y','564ec798-4a21-4148-9ec3-1a787b5d33bd',100,0,TO_TIMESTAMP('2013-01-23 18:19:56','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:56','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Field (IsEncrypted,AD_Tab_ID,DisplayLength,IsSameLine,IsHeading,AD_Column_ID,IsCentrallyMaintained,AD_Field_ID,IsReadOnly,EntityType,Name,IsFieldOnly,IsDisplayed,AD_Field_UU,UpdatedBy,AD_Org_ID,Created,AD_Client_ID,CreatedBy,Updated,IsActive) VALUES ('N',200068,36,'N','N',208435,'Y',201718,'N','D','X_DepositBatchLine_UU','N','Y','3a4a08ce-5c9e-4eea-9860-a4d121eaa3d3',100,0,TO_TIMESTAMP('2013-01-23 18:19:57','YYYY-MM-DD HH24:MI:SS'),0,100,TO_TIMESTAMP('2013-01-23 18:19:57','YYYY-MM-DD HH24:MI:SS'),'Y')
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:21:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201709
;

-- Jan 23, 2013 6:21:22 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:21:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201713
;

-- Jan 23, 2013 6:21:29 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:21:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201710
;

-- Jan 23, 2013 6:21:40 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:21:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201712
;

-- Jan 23, 2013 6:21:49 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:21:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201714
;

-- Jan 23, 2013 6:22:07 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', IsReadOnly='Y', XPosition=4, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:22:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201715
;

-- Jan 23, 2013 6:22:21 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET XPosition=2, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:22:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201708
;

-- Jan 23, 2013 6:22:35 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_Field SET IsSameLine='Y', IsReadOnly='Y', XPosition=5, ColumnSpan=2,Updated=TO_TIMESTAMP('2013-01-23 18:22:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=201717
;

-- Jan 23, 2013 6:23:56 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
INSERT INTO AD_Menu (AD_Window_ID,AD_Menu_ID,IsSummary,IsSOTrx,IsReadOnly,EntityType,AD_Menu_UU,IsCentrallyMaintained,Name,"action",IsActive,AD_Client_ID,CreatedBy,Updated,AD_Org_ID,Created,UpdatedBy) VALUES (200031,200035,'N','N','N','D','e84239a8-560a-4f7c-ba32-fb2e70f1c616','Y','Receipts Into Batch','W','Y',0,100,TO_TIMESTAMP('2013-01-23 18:23:55','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2013-01-23 18:23:55','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_TreeNodeMM SET Parent_ID=236, SeqNo=0, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200035
;
...
-- Jan 23, 2013 6:24:38 PM SGT
-- Ticket #1001569: Move receipts into batch from QS to Idempiere
UPDATE AD_TreeNodeMM SET Parent_ID=236, SeqNo=23, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=200035
;
