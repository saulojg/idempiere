-- 1.0-1.5/postgresql/001_ad_changes.sql
-----------------------------
...
-- 1.0-1.5/postgresql/002_ad_message.sql
-----------------------------
...
-- 1.0-1.5/postgresql/003_m_pricelist.sql
-----------------------------
...
-- 1.6/postgresql/001_ad_Changes for C_Currency.sql
-----------------------------
INSERT INTO AD_Element
(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, 
columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
...
-- 1.6/postgresql/002_ad_message.sql
-----------------------------
INSERT INTO AD_MESSAGE
(ad_message_id, ad_client_id, ad_org_id, isactive, created, createdby, 
updated, updatedby, VALUE, msgtext, msgtip, msgtype, entitytype)
...
-- 1.7.0/postgresql/001_MixedPayment.sql
-----------------------------
...
0,0,195,52000,TO_DATE('2008-05-22 10:55:30','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Mixed',TO_DATE('2008-05-22 10:55:30','YYYY-MM-DD HH24:MI:SS'),100,'M')
;
...
-- 1.7.0/postgresql/002_Terminals_newTableStructure.sql
-----------------------------
-- Jun 2, 2008 9:19:48 PM GMT+04:00
-- Default comment for updating dictionary
INSERT INTO AD_Table (
AccessLevel,AD_Client_ID,AD_Org_ID
,AD_Table_ID,CopyColumnsFromTable,Created,CreatedBy,EntityType,ImportTable,IsActive,IsChangeLog,IsDeleteable,IsHighVolume,IsSecurityEnabled,IsView,LoadSeq,Name,ReplicationType,TableName,Updated,UpdatedBy
) VALUES (
'1',0,0
,52004,'N',TO_DATE('2008-06-02 21:19:47','YYYY-MM-DD HH24:MI:SS'),100,'A','N','Y','N','Y','N','N','N',0,'POS Terminal','L','U_POSTerminal',TO_DATE('2008-06-02 21:19:47','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Ref_Table SET WhereClause='C_BankAccount.IsActive=''Y''',Updated=TO_TIMESTAMP('2008-11-06 09:02:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Reference_ID=53283
;
...
,AD_Table_ID
,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable
...
,18,53283
,52004
,'CardTransferBankAccount_ID',TO_DATE('2008-06-02 21:47:59','YYYY-MM-DD HH24:MI:SS'),100,'Bank account on which to transfer Card transactions','A',22,'Y','N','N','N','N','N','N','N','N','N','Y','Transfer Card trx to',0,TO_DATE('2008-06-02 21:47:59','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- 1.7.0/postgresql/003_Terminals_TransferConfiguration.sql
-----------------------------
...
-- 1.7.0/postgresql/004_Terminals_newTableDDL.sql
-----------------------------
...
-- 1.7.0/postgresql/005_Messages.sql
-----------------------------
...
-- 1.7.3/postgresql/002_ADMessage.sql
-----------------------------
...
-- 1.7.3/postgresql/003_AD_OrgInfo.sql
-----------------------------
ALTER TABLE ad_orginfo ADD COLUMN receiptfootermsg varchar(1023);


-- 1.7.3/postgresql/004_AD_Changes for AD_OrgInfo.sql
-----------------------------
INSERT INTO AD_Element
(ad_element_id, ad_client_id, ad_org_id, isactive, created, createdby, updated, updatedby, 
columnname, entitytype, name, printname, description, help, po_name, po_printname, po_description, po_help)
...
-- 1.7.3/postgresql/005_MissingIDs.sql
-----------------------------
...
-- 1.7.3/postgresql/007_CashPayment.sql
-----------------------------
