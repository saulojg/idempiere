...
public class MLookupFactory
{
	...
	public static MLookup get(Properties ctx, int WindowNo, int TabNo, String columnName, String tableName,
			int AD_Reference_ID) {
		return get(ctx, WindowNo, TabNo, MColumn.getColumn_ID(tableName, columnName), AD_Reference_ID);
	}
